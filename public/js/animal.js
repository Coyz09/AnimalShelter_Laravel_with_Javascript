$('#ctable').DataTable({
 ...
 columns: [
              ...
              { "data": "animal_Breed" },
              { "data": "animal_Age" },
              { "data": "animal_Rescueplace" },
              { "data": "animal_Rescuedate" },
    ...
    $.ajax({
        ...
        success: function(data) {
          if(data.errors)
            ...
            console.log(data.animal.animal_Image);
            $("#myModal").modal("hide");                 
                table.destroy().draw();
               $('#ctable').DataTable({
...
$('#editModal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
        ...
        success: function(data){
               // console.log(data);
               $("#id").val(data.id);
               $("#ename").val(data.animal_Name);
               $("#etype").val(data.animal_Type);
               $("#ebreed").val(data.animal_Breed);
               $("#eage").val(data.animal_Age);
               $("#eplace").val(data.animal_Rescueplace);
               $("#edate").val(data.animal_Rescuedate);
