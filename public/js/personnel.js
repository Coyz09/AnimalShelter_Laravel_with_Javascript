$('#ctable').DataTable({
 ...
 columns: [
              { "data": "id" },
              { "data": "personnel_Fname" },
              { "data": "personnel_Lname" },
              { "data": "personnel_Job" },
    ...
    $.ajax({
        ...
        success: function(data) {
          if(data.errors)
            ...
            console.log(data.personnel.img);
            $("#myModal").modal("hide");
                table.destroy().draw();
                $('#ctable').DataTable({
...
$('#editModal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
        ...
        success: function(data){
               // console.log(data);
               $("#id").val(data.id);
               $("#efname").val(data.personnel_Fname);
               $("#elname").val(data.personnel_Lname);
               $("#ejob").val(data.personnel_Job);
               $("#econtact").val(data.personnel_Contact);
               // $("#eimg").val(data.img);
          },
         error: function(){
